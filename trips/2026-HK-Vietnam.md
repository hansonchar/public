# Vietnam 8 days itinerary, 2026

Vietnam: March 2 - 9 (after HK: Feb 24 – Mar 1)

| Day | Focus | Destination & Activities | Travel Time |
| :--- | :--- | :--- | :--- |
| **Day 1** | **Arrival & Old Quarter** | Arrive in Hanoi, aka **Noi Bai International Airport (HAN)**, from HK. Check into your hotel. Spend the afternoon/evening walking the **Old Quarter** (36 Streets), exploring Hoan Kiem Lake, and having a classic street food dinner (e.g., *Bún Chả*). | ~1 hr transfer from airport (Noi Bai, HAN) |
| **Day 2** | **Hanoi Culture Day** | Morning: Visit the **Ho Chi Minh Mausoleum Complex** (exterior view of Mausoleum, Stilt House, One-Pillar Pagoda) and the **Temple of Literature**. Afternoon: Explore the **Hanoi French Quarter** (Opera House, St. Joseph's Cathedral). Evening: Attend a traditional **Water Puppet Show**. | Local transport / Walking |
| **Day 3** | **Cruise Day 1** | Morning: Cruise shuttle pick-up from hotel. **Travel** to **Got Pier** (for Lan Ha Bay). Afternoon: Check-in, start cruising **Lan Ha Bay** (recommended over Ha Long for fewer crowds). Kayak and swim. Dinner on board. | 2.5–3 hours by shuttle |
| **Day 4** | **Cruise Day 2** | Full day exploring the beautiful karsts of Lan Ha Bay. Enjoy on-board activities, visit a quiet beach, or a hidden lagoon. Enjoy a second night under the stars on the bay. | None (on board) |
| **Day 5** | **Cruise & Direct Transfer** | Morning: Last cruise activities (e.g., Tai Chi, cave visit). Mid-day: Disembark. **Transfer directly from the cruise port to Ninh Binh** (Tam Coc/Trang An area). Afternoon: Check into your countryside stay (homestay or resort) and relax. | 3.5–4 hours direct transfer |
...
- Double check on bookings at Ninh Binh
